...
This was our first project using C#. We mainly had experience with Python, so the project helped us learn C# syntax, arrays, functions, loops, conditionals and user input.
...
Player 1 uses X and Player 2 uses O. On each turn, enter the number of an available square.
